  ...
  return (
    ...
    >
      <div className="relative w-full h-20 bg-gray-800">
        {/* ! Future Feature ADD TO Favorites */}
        {/* <button
        ...
        <div
          className={`absolute top-2 left-2 px-2 py-1 rounded-lg text-sm font-semibold
            ${getJobTypeStyles(jobType)} 
            w-full max-w-[90%] lg:max-w-[80%] md:max-w-[70%] sm:max-w-[40%]`}
        >
          {jobType}
        </div>
