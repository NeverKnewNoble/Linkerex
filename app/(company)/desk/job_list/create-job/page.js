...
//       setAlert({
//         type: "danger",
//         message: `Failed to create job listing: ${errorData.error}`,
//       });
//     }
//   };
...
//         <h1 className="text-[50px] font-bold ml-8 mt-5">Create New Job</h1>
//         <div className="max-w-[1900px] w-[1200px] mt-5 ml-5">
//           {alert && (
  ...
  return (
    ...
    >
      <div className="w-full bg-[#1a1a1a] min-h-screen mx-4 my-5 rounded-lg shadow-lg text-gray-300">
        ...
        <div className="max-w-[1900px] w-full sm:w-[1200px] mt-5 ml-4 sm:ml-5">
          {alert && (
            <Alert color={alert.type === "success" ? "success" : "error"}>
              {alert.message}
            </Alert>
