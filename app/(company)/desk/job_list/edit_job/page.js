...
export default function EditJob() {
  ...
  const deleteById = async () => {
    try {
      ...
      if (res.ok) {
        ...
        // Optional: Refresh or redirect after successful deletion
        router.push("/desk/job_list"); // Redirect to job list
      } else {
  ...
  return (
    <div className="min-h-screen bg-cover bg-center flex items-center justify-center p-4">
      <div className="w-full bg-[#1a1a1a] min-h-screen mx-10 my-5 rounded-lg shadow-lg text-gray-300">
        ...
        <div className="max-w-[1900px] w-[1200px] mt-5">
          {alert && (
        ...
        <div className="mt-4">
          <button
            className="px-6 py-3 mr-2 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
            onClick={handleSave}
          >
            Save Changes
          </button>
          <button
            className="px-6 py-3 bg-red-500 text-white font-semibold rounded-lg shadow-md focus:outline-none "
